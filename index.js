...
contributionsCard.innerHTML = `${GAMES_JSON.reduce( (acc, game) => acc + game.backers, 0).toLocaleString('en-US')}`;
...
raisedCard.innerHTML = `$${GAMES_JSON.reduce( (acc, game) => acc + game.pledged, 0).toLocaleString('en-US')}`;
